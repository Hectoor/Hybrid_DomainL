...
class GTA5DataSet(data.Dataset):
    def __init__(self, root, list_path, max_iters=None, img_size=(321, 321), norm=False, random_mirror=False, random_crop=False, ignore_label=255, transform=None):
        self.root = root
    ...
    def __getitem__(self, index):
        ...
        if self.random_crop:
            ...
            if img_h < crop_h or img_w < crop_w:
                ...
                image = image.crop((w_off, h_off, w_off+crop_w, h_off+crop_h))  # 指定大小，实际上是由crop来完成的
