...
ITER_SIZE = 1
NUM_WORKERS = 8
DATA_DIRECTORY = '/mnt/mdisk/zyh/DADatasets/GTA5/data'
#DATA_DIRECTORY = '/mnt/mdisk/zyh/DADatasets/gta5_deeplaball/'
...
NUM_STEPS_STOP = 100000 #80000  # early stopping
POWER = 0.9
RANDOM_SEED = 1234
...
TARGET = 'cityscapes'
SET = 'train'
DATA_LIST_PATH_VAL = './datasets/cityscapes_list/val.txt'
LAMBDA_SEG_TRG = 1e-2

EXP_ROOT = "/media/HDD_4TB/zyh/advent/experiments/sy1_baseline_withapex"
...
def get_arguments():
    ...
    parser.add_argument("--apex", type=bool, default=False,
                        help="using apex")
    parser.add_argument("--data-label-folder-target", type=str, default='',
                        help="Path to the soft assignments in the target dataset.")
    parser.add_argument("--lambda-seg-trg", type=float, default=LAMBDA_SEG_TRG,
                        help="lambda_ent")
    parser.add_argument("--data-list-path-val", type=str, default=DATA_LIST_PATH_VAL,
